...
using ChatTeamChallenge.Application.Disputes.Chats;
using ChatTeamChallenge.Application.Disputes.Messages;
...
public static class ServiceExtension
{
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddTransient<IMessageFileService, MessageFileService>();
    ...
    public static void AddPersistence(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddDbContext<ChatTeamChallengeDbContext>(options => 
